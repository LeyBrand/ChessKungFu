...
from rendering.frame_renderer import (
    render_frame, SIDEBAR_WIDTH, init_scoring, init_move_log, init_animations, init_sound,
)
...
def main():
    ...
    init_animations(bridge.event_bus)
    init_sound(bridge.event_bus)
